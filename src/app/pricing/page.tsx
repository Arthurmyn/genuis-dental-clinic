...
const DESCRIPTION =
  "Прайс-лист стоматологии Genius в Астане: терапия, хирургия, ортопедия, ортодонтия, имплантация, All-on-4 и All-on-6. Точную стоимость лечения определяет врач на консультации.";
