...
const dictionary = {
  ...
  hero: {
    ...
    heading: {
      ru: ["Лечение зубов", "с заботой о результате"],
      kk: ["Нәтижеге қамқорлықпен", "тіс емдеу"],
    },
    description: {
  ...
  popup: {
    heading: { ru: "Записаться на приём", kk: "Қабылдауға жазылу" },
    description: {
      ru: "Свяжитесь с администратором, и мы быстро вас направим.",
      kk: "Әкімшімен байланысыңыз, біз сізді жылдам бағыттаймыз.",
    },
