    ...
    <section id="doctors" className="py-6">
      <Container>
        <Panel className="flex flex-col gap-8">
          ...
          <div className="no-scrollbar -mx-6 flex min-w-0 snap-x snap-mandatory gap-4 overflow-x-auto px-6 pb-2 scroll-pl-6 sm:-mx-10 sm:px-10 sm:scroll-pl-10 lg:mx-0 lg:grid lg:grid-cols-4 lg:overflow-visible lg:px-0 lg:pb-0 lg:scroll-pl-0">
